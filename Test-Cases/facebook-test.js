...
describe('Example Test', function() {
    it('should perform actions on Facebook registration form', async function() {
        ...
        try {
            ...
            let month_value = await month_m.getAttribute("value")
            assert.strictEqual(month_value, "9", "Selected month should be '9'.");
